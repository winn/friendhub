/*
  ...
  1. Changes
    ...
    - Set up RLS policies
    - Ensure content field is NOT NULL
...
CREATE TABLE messages (
  ...
  content text NOT NULL CHECK (length(trim(content)) > 0), -- Ensure content is not empty
...
COMMENT ON COLUMN messages.content IS 'The actual message content (cannot be null or empty)';
