/*
  # Fix Conversations Table Foreign Key Constraints

  1. Changes
    - Recreate tables in correct order with proper constraints
    - Add RLS policies
...
-- Create agents table (depends on users)
CREATE TABLE agents (
...
-- Create conversations table (depends on users and agents)
